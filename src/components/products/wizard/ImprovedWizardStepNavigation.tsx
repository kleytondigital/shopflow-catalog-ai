  ...
  return (
    <div className="bg-white border-b border-gray-200">
      <div className="px-2 md:px-6 py-2 md:py-4">
        <div className="flex items-center justify-between space-x-1 md:space-x-4 overflow-x-auto pb-2 scrollbar-thin scrollbar-thumb-gray-300">
          {steps.map((step, index) => (
            <React.Fragment key={step.id}>
              <div
                className={cn(
                  "flex items-center space-x-1 md:space-x-3 cursor-pointer transition-all duration-200 min-w-0 flex-shrink-0",
              ...
              >
                ...
                {/* Step Content - Hide text on mobile */}
              ...
              {index < steps.length - 1 && (
                <ChevronRight
                  className={cn(
                    "w-4 h-4 md:w-5 md:h-5 transition-colors duration-200 flex-shrink-0",
