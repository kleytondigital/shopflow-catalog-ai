...
import { Check, Package, DollarSign, Image, Search, Settings } from 'lucide-react';
      ...
      <div className="px-6 py-4">
        <nav className="flex space-x-8 overflow-x-auto">
          {steps.map((step, index) => {
            ...
            const IconComponent = stepIcons[step.id as keyof typeof stepIcons] || Package;
            ...
            return (
              <button
                ...
                className={cn(
                  "flex flex-col items-center min-w-0 group transition-all duration-200",
              ...
              >
                ...
                <div className="flex items-center mb-2">
                  ...
                  {index < steps.length - 1 && (
                    <div
                      className={cn(
                        "w-16 h-0.5 ml-4 transition-colors duration-200",
        ...
        <div className="mt-4">
          ...
          <div className="flex justify-between mt-2 text-xs text-gray-500">
            ...
            <span>{Math.round(((currentStep + 1) / steps.length) * 100)}% concluído</span>
          </div>
        </div>
      </div>
    </div>
