-- Script manual para adicionar grades padrão ao sistema
...
-- 6. Verificar se as grades foram criadas
SELECT 'Grades criadas com sucesso!' as status;
SELECT mg.name as grupo, mv.value as grade, mv.display_order
FROM public.variation_master_groups mg
JOIN public.variation_master_values mv ON mv.group_id = mg.id
WHERE mg.attribute_key = 'grade'
